        ...
        <section class="mx-auto flex w-full max-w-6xl flex-col gap-6">
            ...
            >
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="rounded-xl border-2 border-brand-stroke bg-brand-accent p-3"
                        >
                            <Bell class="h-6 w-6" />
                        </div>
                        <div>
                            <p
                                class="text-xs font-black uppercase text-brand-paragraph"
                            >
                                Announcements
                            </p>
                            <h1
                                class="text-3xl font-black leading-tight text-brand-headline md:text-5xl"
                            >
                                Company Updates
                            </h1>
                        </div>
                ...
                >
                    ...
                    <div class="p-6">
                        ...
                        >
                            <div class="min-w-0">
                                <p
                                    class="mb-1 text-[10px] font-black uppercase text-brand-bg"
                                >
                                    {{
                                ...
                                <h2
                                    class="text-2xl font-black leading-tight wrap-break-word"
                                >
                                    {{ announcement.title }}
                                </h2>
                            </div>
                            ...
                            <span
                                ...
                                :style="{
                                    ...
                                    color: getAnnouncementStyle(announcement)
                                        .text,
                                }"
                            >
                        ...
                        >
                            <h3
                                class="mb-3 inline-flex items-center gap-2 text-sm font-black uppercase"
                            >
            ...
            >
                <p class="text-xs font-black uppercase text-brand-bg">
                    Showing {{ props.announcements.from }}-{{
